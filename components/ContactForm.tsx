      ...
      <section id="contact" className="bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <p className="mt-3 text-earth-600">
            Nous vous recontactons sous 24h. En attendant, vous pouvez nous
            appeler directement.
          </p>
          <a
            href="tel:0752620818"
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <FadeIn>
          <div className="mb-12 text-center lg:mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-earth-900 lg:text-5xl">
            ...
            <div className="rounded-2xl border border-earth-200/50 bg-white p-7 shadow-sm lg:p-9">
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label htmlFor="prenom" className="mb-1.5 block text-sm font-medium text-earth-800">
                      Prénom
                    </label>
                    <input type="text" id="prenom" name="prenom" autoComplete="given-name" required value={form.prenom} onChange={handleChange} className={inputClasses} placeholder="Votre prénom" />
                  </div>
                  <div>
                    <label htmlFor="nom" className="mb-1.5 block text-sm font-medium text-earth-800">
                      Nom
                    </label>
                    <input type="text" id="nom" name="nom" autoComplete="family-name" required value={form.nom} onChange={handleChange} className={inputClasses} placeholder="Votre nom" />
                  </div>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input type="email" id="email" name="email" autoComplete="email" required value={form.email} onChange={handleChange} className={inputClasses} placeholder="votre@email.fr" />
                  </div>
                  <div>
                    <label htmlFor="telephone" className="mb-1.5 block text-sm font-medium text-earth-800">
                      Téléphone
                    </label>
                    <input type="tel" id="telephone" name="telephone" autoComplete="tel" required value={form.telephone} onChange={handleChange} className={inputClasses} placeholder="06 00 00 00 00" />
                  </div>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label htmlFor="ville" className="mb-1.5 block text-sm font-medium text-earth-800">
                      Ville / Code postal
                    </label>
                    <input type="text" id="ville" name="ville" autoComplete="address-level2" required value={form.ville} onChange={handleChange} className={inputClasses} placeholder="Vallet 44330" />
                  </div>
                  <div>
                    <label htmlFor="besoin" className="mb-1.5 block text-sm font-medium text-earth-800">
                      Besoin principal
                    </label>
                    <select id="besoin" name="besoin" required value={form.besoin} onChange={handleChange} className={inputClasses}>
                ...
                <div>
                  <label htmlFor="message" className="mb-1.5 block text-sm font-medium text-earth-800">
                    Message <span className="font-normal text-earth-400">(optionnel)</span>
                  </label>
                  <textarea id="message" name="message" rows={3} value={form.message} onChange={handleChange} className={inputClasses} placeholder="Décrivez votre besoin..." />
                </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3 rounded-xl bg-white p-4 shadow-sm">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-earth-900">Réponse sous 24h</p>
                    <p className="text-xs text-earth-400">Par téléphone dans la journée</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 rounded-xl bg-white p-4 shadow-sm">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-earth-900">Crédit d&apos;impôt 50 %</p>
                ...
                <div className="flex items-center gap-3 rounded-xl bg-white p-4 shadow-sm">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-earth-900">Sans engagement</p>
              ...
              <div className="rounded-xl border border-earth-200/50 bg-white p-5 shadow-sm">
                ...
                <p className="text-sm italic leading-relaxed text-earth-600">
                  &ldquo;Jessy est attentif, patient et très à l&apos;écoute. Je recommande vivement.&rdquo;
                </p>
                <div className="mt-3 flex items-center gap-2">
                  <div className="flex gap-0.5">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} size={12} strokeWidth={0} fill="currentColor" className="text-star" />
                    ))}
                  </div>
                  <span className="text-xs text-earth-400">— Claudie E., avis Google</span>
                </div>
              </div>
